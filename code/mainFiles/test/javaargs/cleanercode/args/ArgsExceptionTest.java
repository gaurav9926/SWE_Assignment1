...
public class ArgsExceptionTest extends TestCase {
  ...
  public void testDoubleWithIntegerMessage() throws Exception {
    ArgsException e = new ArgsException(DOUBLE_INTEGER, 'x', "89.2");
    assertEquals("Argument -x expects an integer but was given a double value: '89.2'.", e.errorMessage());
  }
