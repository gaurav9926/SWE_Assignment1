...
public class ArgsTest {
  ...
  @Test
  public void testDoubleWithInteger() throws Exception {
    try {
      new Args("x#", new String[]{"-x", "89.2"});
      fail();
    } catch (ArgsException e) {
      assertEquals(DOUBLE_INTEGER, e.getErrorCode());
      assertEquals('x', e.getErrorArgumentId());
      assertEquals("89.2", e.getErrorParameter());
    }
